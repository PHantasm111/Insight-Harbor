...
export function StickyNavbar() {
  ...
  {/* navbar list */ }
  const navList = (
    <ul className="mt-4 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-10 ">
      <Typography
        as="li"
        variant="paragraph"
        color="blue-gray"
    ...
    <div className="max-h-[768px] w-full">
      <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4" >
                  ...
                  <Menu placement="bottom-start">
                    <MenuHandler>
                      <Avatar
                        ...
                        alt="user profile"
                        withBorder={true}
                        className="cursor-pointer p-0.5 hover:border-none"
                        src={boat}
                      />
                    </MenuHandler>
                    <MenuList>
                      ...
                      <MenuItem className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                        <svg
                          width="16"
                          height="14"
                          viewBox="0 0 16 14"
                        ...
                        <Typography variant="small" className="font-medium" color="blue-gray" onClick={() => { handleRedirect(); logout(); }}>
                          Sign Out
                        </Typography>
                      </MenuItem>
                    </MenuList>
              ...
              : (
                <div className="flex items-center gap-x-1">
                  ...
                  <Button
                    variant="gradient"
                    size="md"
                    className="hidden lg:inline-block font-bold"
        ...
        <Collapse open={openNav}>
          {navList}
          {!currentUser && <div className="flex items-center gap-x-1">
            <Button fullWidth variant="text" size="sm" className="" onClick={handleLogin}>
              <span>Log In</span>
            </Button>
            <Button fullWidth variant="gradient" size="sm" className="" onClick={handleRegister}>
              <span>Sign in</span>
            </Button>
          </div>}
        </Collapse>
